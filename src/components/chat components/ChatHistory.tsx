...
export default function ChatHistory() {
  ...
  return (
    <div className={(!currentGroup)?"flex flex-col md:w-1/4 md:shrink-0": "md-0 h-0 invisible md:visible md:h-screen"}>
      ...
      <div className="flex flex-col justify-between ">
        <div className="p-4 h-4/6 overflow-auto">
        ...
        <div className="h-1/6 w-full fixed flex-shrink-0 bottom-0 bg-purple-600 flex flex-row p-4 justify-between text-center">
