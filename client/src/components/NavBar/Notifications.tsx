...
export default function Notifications(){
    return (
        ...
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md border bg-gray-900 px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-purple-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
